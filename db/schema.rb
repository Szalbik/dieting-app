...
ActiveRecord::Schema[8.0].define(version: 20_260_311_233_000) do
  ...
  create_table 'canonical_product_aliases', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[canonical_product_id name], name: 'idx_canonical_aliases_on_product_and_name', unique: true
  ...
  create_table 'canonical_products', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id name], name: 'index_canonical_products_on_user_id_and_name', unique: true
  ...
  create_table 'custom_cart_items', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[shopping_cart_id name], name: 'index_custom_cart_items_on_shopping_cart_id_and_name'
  ...
  create_table 'meal_plan_product_substitutions', force: :cascade do |t|
    ...
    t.index %w[user_id meal_plan_id product_id replacement_product],
            name: 'index_meal_plan_product_substitutions_on_scope_and_replacement', unique: true
  ...
  create_table 'product_substitutions', force: :cascade do |t|
    ...
    t.index %w[user_id source_product replacement_product], name: 'index_product_substitutions_on_user_and_pair',
                                                            unique: true
  ...
  create_table 'shopping_cart_invitations', force: :cascade do |t|
    ...
    t.index %w[inviter_id invitee_id status], name: 'idx_cart_invites_on_pair_and_status'
  ...
  create_table 'substitution_product_matches', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id source_product matched_product_name],
            name: 'index_substitution_product_matches_on_user_source_and_match', unique: true
