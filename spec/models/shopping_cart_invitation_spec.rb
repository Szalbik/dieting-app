...
RSpec.describe ShoppingCartInvitation, type: :model do
  describe '#accept!' do
    it 'connects both users to one active shopping cart and syncs their meal items' do
      ...
      create(:shopping_cart_item, shopping_cart: inviter.owned_shopping_cart, product: inviter_product, meal_plan: inviter_meal_plan)
      create(:shopping_cart_item, shopping_cart: invitee.owned_shopping_cart, product: invitee_product, meal_plan: invitee_meal_plan)
