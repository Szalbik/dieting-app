ActiveAdmin.setup do |config|
  ...
  config.on_unauthorized_access = :handle_active_admin_unauthorized
  ...
  config.current_user_method = :active_admin_current_user
...
ActiveSupport.on_load(:active_admin_controller) do
  include ActiveAdminAuthentication
end
